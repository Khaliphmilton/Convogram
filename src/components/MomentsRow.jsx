  ...
  return <>
    ...
    {selected&&<div className="story-viewer" onClick={close}>
      <div className="story-shell" onClick={e=>e.stopPropagation()} onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd}>
        ...
        {!isOwner&&<div className="story-reactions"><button onClick={toggleLike} disabled={busy} className={liked?'liked':''}><Heart size={18} fill={liked?'currentColor':'none'}/><span>Like</span></button></div>}
